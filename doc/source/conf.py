...
# -*- coding: utf-8 -*-
#
# diffpy.getangle documentation build configuration file, created by
...
modindex_common_prefix = ["diffpy.getangle"]
...
basename = "diffpy.getangle".replace(" ", "").replace(".", "")
...
latex_documents = [
    ("index", "diffpy.getangle.tex", "diffpy.getangle Documentation", ab_authors, "manual"),
]
...
man_pages = [("index", "diffpy.getangle", "diffpy.getangle Documentation", ab_authors, 1)]
